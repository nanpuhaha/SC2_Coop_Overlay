...
class ChatMessage():
    ...
    def __init__(self, parent):
        ...
        self.message.setSizePolicy(QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.MinimumExpanding))
        font = parent.font()
...
class ChatWidget(QtWidgets.QWidget):
    ...
    def __init__(self, chat_font_scale=1.3, geometry=None, parent=None):
        ...
        self.scroll_area.setSizePolicy(QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding))
